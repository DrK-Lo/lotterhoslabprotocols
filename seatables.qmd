...
-   Check the plugs for corrosion. Scrub with green abrasive pad.
    ...
    -   ![Image Name](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts1.JPG){alt="Image Name"}
...
![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts2.JPG){alt=""} ![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts3.JPG){alt=""}
...
![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts4.JPG){alt=""}

Also look for signs that the bulb is burning out by the black residue inside the quartz tube:

![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts10.JPG){alt=""}
...
![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts6.JPG){alt=""}
...
![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts8.JPG){alt=""}

Make sure to follow these instructions as you put it back together:

![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts9.JPG){alt=""}

This is wrong:

![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts14.JPG){alt=""}

Make sure when you put it back together, screw in the coupling tight before attaching it to the housing:

![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts15.JPG){alt=""}

It's hard to see, but check that the gasket is securely in place:

![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts16.JPG){alt=""}

When you put the wires in, make sure not to let them get twisted by carefully stuffing them inside,

![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts17.JPG){alt=""}

then holding the top wire taught (don't let it twist) while you screw the top on:

![](https://drk-lo.github.io/lotterhoslabprotocols/img/UVpicts18.JPG){alt=""}
