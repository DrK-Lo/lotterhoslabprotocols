...
-   Globus is a system for transferring files. The pros:
    ...
    -   Globus is already integrated with Explorer and our lab files.
...
## **Getting started with Globus on Explorer** {.unnumbered}
...
-   Click on "File Manager" and the Search Icon. In the Search Box type "Northeastern". Choose "northeastern#discovery". This is your home directory on Explorer. Click on the Bookmark Icon to add this to your bookmarks.

-   Dr. Lotterhos will share through Globus the specific folders that you will have access to on the Explorer Lab Storage
...
Here is an example of a transfer between the Lotterhos Archive on NESE and the `/projects/lotterhos` on the Explorer Cluster (although it says `/work/lotterhos` on Discovery, it has been remapped).
