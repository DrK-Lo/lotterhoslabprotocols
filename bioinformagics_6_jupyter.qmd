...
Let's first open two windows to use. 
...
- Then we'll add a second tab in the same window - using the menu bar: Shell > Split Horizontally with Current Profile. This will be referred to as Window #2.
