...
- Example image of tube without barcodes below:
![](img/tubelabel.jpeg)

# Tips for printing:
- take out all the paper from the printer
- For the MSC color printer (HP M553), the label side should be face up. For the MSC B&W printer (HP laser jet 600), the label side should be face down. The B&W printer should be your first option since the labels are less likely to be stuck if you load several at once.
