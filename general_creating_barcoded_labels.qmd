...
- We have had issues with the QR codes not matching the labels, which may happen when someone makes new labels but forgets to update the QR codes. Make sure to spot check all QR codes match the labels! When in doubt, we go with the written label and not the QR codes

- Test the labels on the QR screen before you print!
...
- Let the  B&W printer cool off between printing
