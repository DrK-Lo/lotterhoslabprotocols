...
You'll need to send Stefan your public key. Public keys can be created following the steps here: <https://confluence.atlassian.com/bitbucketserver/creating-ssh-keys-776639788.html> And is described in ![this pdf](https://drk-lo.github.io/lotterhoslabprotocols/img/RSAKeys.pdf){alt="this pdf"}
...
![htop example](https://drk-lo.github.io/lotterhoslabprotocols/img/htop_screenshot.png){alt="htop example"}
