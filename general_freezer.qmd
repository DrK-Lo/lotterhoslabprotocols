...
------------------------------------------------------------------------
## Freezer Defrost Notes May 2024 (20240521)
...
![](img/scraping_ice.png){alt=""}
![](img/remove_ice.png){alt=""}
![](img/frost_near_seal.png){alt=""}

3. Then we discarded boxes that we didn't have any data for (Unmapped Boxes section in app). 
