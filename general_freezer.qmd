...
![All data about the freezer box should be written on the sticky label and added to the app](img/freezer_labels.jpeg){width=70%}
...
![Katie scraping ice off of the shelf doors](img/scraping_ice.jpeg){width=70%}

![Scrape the ice fully off of the doors](img/remove_ice.jpeg){width=70%}

![Make sure to be very careful near the seals, do not make nicks with the sharp edge](img/frost_near_seal.jpeg){width=70%}
...
![Use the ice scraper to help remove stubborn frozen drawers](img/frozen_drawer.jpeg){width=70%}
...
![Let the empty boxes dry out after removing from freezer. Remove all tape labels.](img/empty_boxes.jpeg){width=70%}
