...
# General -80 Freezer Organization Protocol & Clean Out Notes, May 2024 (Katie, Madeline, Camille, Lee)
...
![All data about the freezer box should be written on the sticky label and added to the app](img/freezer_labels.jpeg){alt=""}
...
## Clean Out Notes, May 21 2024 {.unnumbered}
...
![Katie scraping ice off of the shelf doors](img/scraping_ice.jpeg){alt=""}

![Scrape the ice fully off of the doors](img/remove_ice.jpeg){alt=""}

![Make sure to be very careful near the seals, do not make nicks with the sharp edge](img/frost_near_seal.jpeg){alt=""}
...
![Use the ice scraper to help remove stubborn frozen drawers](img/frozen_drawer.jpeg){alt=""}
...
![Let the empty boxes dry out after removing from freezer. Remove all tape labels.](img/empty_boxes.jpeg){alt=""}
