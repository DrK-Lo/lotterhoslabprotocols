...
------------------------------------------------------------------------
## -80 Freezer Defrost Protocol & Notes, May 2024 (Katie, Madeline, Camille, Lee) {.unnumbered}

1.  The first thing we did is review the new app and located any unmapped boxes or boxes that we want to discard. 
...
![Katie scraping ice off of the shelf dooors](img/scraping_ice.jpeg){alt=""}
