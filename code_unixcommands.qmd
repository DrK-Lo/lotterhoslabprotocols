...
[Edit this page](https://github.com/DrK-Lo/lotterhoslabprotocols/edit/main/code_unixcommands.qmd)
...
1) [`cd` - Changing Directories](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands.html#change-directory---cd)
2) [`find` - Finding files](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands.html#find-target-files---find)
3) [`ls` - Listing files](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands.html#listing-files-and-directories---ls)
4) [`sed` - Replacing texts in a file name](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands.html#replacing-characters-in-a-txt-file--sed)
5) [`chmod`- Changing file or folder permissions](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands.html#changing-permission---chmod)
6) [`wc` - Count words or lines or a file](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands.html#counting-words-or-lines---wc)
7) [`awk` - Printing specific lines or columns](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands.html#selecting-a-specific-lines-or-columns-from-a-files---awk)

## **Change directory - `cd`** {.unnumbered}
...
![Quick Directory Access](https://drk-lo.github.io/img/quickdirectory.gif){alt="Quick Directory Access"}

## **Find target files - `find`** {.unnumbered}
...
## **Listing files and directories - `ls`** {.unnumbered}

**List just subdirectories in the current directory**

    ls -d */

## **Replacing characters in a txt file -`sed`** {.unnumbered}
...
## **Changing Permission - `chmod`** {.unnumbered}
...
Use mac GUI: ![Change Permissions](https://github.com/DrK-Lo/lotterhoslabprotocols/blob/775c1810a304763a7f457893654f2aff233f08ca/img/changepermissions.gif)

## **Counting words or lines - `wc`** {.unnumbered}

    wc -l myfile.txt

## **Selecting a specific line(s) or column(s) from a file(s) - `awk`** {.unnumbered}
...
#### **Still editting below this point (possibly moving to new file since this is not a basic unix command)** {.unnumbered}
