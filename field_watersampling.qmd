...
[Edit this page](https://github.com/DrK-Lo/lotterhoslabprotocols/edit/main/field_watersampling.qmd)
...
4.  Rinse bottle three times with salt water, then gently fill the bottle by making opening parallel to water surface **Minimize the creation of bubbles when you are filling the glass bottles**

5.  As bottle begins to fill, slowly submerge lower end to continue filling bottle **Leave about 1cm between the glass stopper and the the top of the water**
...
## **Upon returning to MSC** {.unnumbered}
...
2.  Place bottles in the Ries lab freezer with other samples **Be careful not to get mecuric chloride on the outside of the glass bottles or caps** (since we handle them without gloves when we eventually run them on the VINDTA) Therefore, **take out stoppers, use mecuric chloride, dispose of gloves, and restopper**
