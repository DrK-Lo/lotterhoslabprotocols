...
-   To connect to the smb server, follow these directions to map to the server on a computer [this document](https://drk-lo.github.io/lotterhoslabprotocols/discovery_3-storage/accessing_shared_storage_2020.pdf) (typically Katie only)
...
-   ![](https://drk-lo.github.io/lotterhoslabprotocols/discovery_3-storage/globalprotectgetittowork.png){alt=""}
...
-   ![](https://drk-lo.github.io/lotterhoslabprotocols/discovery_3-storage/howtofindvolumeinglobusconnect.png){alt=""}
