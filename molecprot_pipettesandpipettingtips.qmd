...
- Each pipette is marked with a certain color tape that corresponds to the type(s) of tips that are compatible with it. Tip boxes are also marked with tape using the same color code, so if you're ever unsure what tips to use with a pipette, just look at the tape.

- Red tape: 0.1-2.5 uL tips

- Orange tape: 0.1-10 uL tips

- Yellow tape: 1-200 uL tips

- Green tape: 1-300 uL tips
