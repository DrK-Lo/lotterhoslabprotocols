...
[Edit this page](https://github.com/DrK-Lo/lotterhoslabprotocols/edit/main/profdev_design.qmd)

------------------------------------------------------------------------

## **Access NU Creative Cloud** {.unnumbered}

We have access to In Design, Illustrator, Photoshop, and Adobe Pro (for editing pdfs). Here is how to access the [Adobe Creative Cloud](https://adobe.northeastern.edu/) and make sure to [follow the instructions here](https://service.northeastern.edu/ogs?id=kb_article&sys_id=4128ecdb1b42745069590dc1604bcbb2) (choose "active directory")

## **Guidance and resources** {.unnumbered}
