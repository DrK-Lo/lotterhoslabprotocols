...
Calculates the volume of undiluted stock PicoGreen needed to make diluted PicoGreen for a given number of standards and samples.
 ...
 <span style="color:red"> You can add links in Quarto e.g. @eq-Pico1 (https://quarto.org/docs/authoring/cross-references.html#equations) </span>
...
-   Finally use the spreadsheet to convert absorbance values to associated concentrations.
 ...
 <span style="color:red"> overall this was hard to follow, some photos or links to an instruction manual would help </span>
