...
-   Flat bottom black Costar 96-well plate (Fisher Cat #: 07-200-627) (long drawer under microscopes)

-   PCR plate, 96-well, 0.3 mL, semi-skirted (Fisher Brand, Cat#: 14230244) (shelf above post-PCR pipettes_
...
- Once samples have thawed, vortex and centrifuge the plate to make sure DNA is spread evenly throughout the sample.

-   Dilute your DNA samples. Use the Easy-Pet with a 2mL tip to transfer 2mL of MilliQ H20 into a liquid boat. Using the P100 multichannel pipette, add 20uL of MilliQ H20 to all wells of a 96 well PCR plate. Using the P10 multichannel pipette **with filtered tips**, add 2uL of your DNA to the corresponding wells of the PCR plate. 

- Seal the PCR plate with a plastic sticky cover, vortex with the plate attachment, and centrifuge with 'short' setting, using a tip wafer as a counterweight. This is a 1:10 dilution as required to be read by PicoGreen.

- If you are quantifying a full plate of samples, set up 2 black flat-bottom well plates. Use the first one for your samples from columns 1-6, and put the Picogreen standards in column 12. Use the second one for your samples from columns 7-12, and add the standards to column 1. If you are using two plates, you will need to create double the amounts of ladder standards. 

-   Dilute your 20X TE to 1X TE. Using a 25mL Easy-Pet tip, pipette 9.5 mL of Molecular Grade H2O into a 15mL falcon tube. Using a p1000 single channel pipette and unfiltered tips, add 500ul of 20X TE to the falcon tube. This solution is stable long term so you can make more than you will need and store for later use. If you will not be using it frequently, you can also calculate exactly how much you need and just make enough for that use.
...
- To make Dilution 2, use the P2.5 and P10 single channel pipettes to combine 1uL of Dilution 1 and 9uL of 1X TE in another 0.2 mL snap cap tube. Vortex and spin Dilution 2 in the mini centrifuge. Double these quantities if you are using two Picogreen plates. 
...
- Using the correct pipette, add the appropriate volume of 1X TE into each standard well according to Table 2. For example, for standard 1, use the P100 single channel and pipette 25 uL of 1X TE in the appropriate well.
