...
- The first or last column of your plate needs to be saved for the ladder standards. Therefore, if you are running 96 samples, they will not fall fit on one plate (max on one plate with standards is 88). So, If you are quantifying a full plate of samples, set up 2 black flat-bottom 96-well plates. Use the first one for your samples from columns 1-6. The Picogreen standards will go in column 12. Use the second plate for your samples from columns 7-12. The PicoGreen standards will go in column 1. Label both plates with lab tape (see example picture).
