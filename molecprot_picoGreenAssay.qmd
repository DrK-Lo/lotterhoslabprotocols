...
### **Equation 1 ** {.unnumbered}
 ...
 <span style="color:red"> Oh here they are! You can add links in Quarto e.g. @eq-Pico1 (https://quarto.org/docs/authoring/cross-references.html#equations) . What is this calculatng? The volume of stock that you will need?</span>
 
$$
(1.1 * (50 /microL diluted PicoGreen * (#samples + #standards))/200 = (vol of Stock PicoGreen)
$$ {#eq-Pico1}
