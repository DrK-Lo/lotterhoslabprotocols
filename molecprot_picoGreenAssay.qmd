...
- Prepare the sample wells according to Table 3. Use the P10 multichannel pipette to add 1 uL of the diluted DNA to each of the sample wells.
...
- Pipette 50ul of the diluted PicoGreen into each well. When adding the diluted PicoGreen, pipette up and down at least 20 times to mix sample, 1X TE and PicoGreen together.

- Cover the plate with a plastic tape sheet and briefly spin down the plate to get all liquid to the bottom of the well. Use the Lotterhos lab centrifuge and a pipette tip wafer as a counterweight.
