...
Basically, if each inner receptical holds less than 30mL and the total box weight is less than 64 pounds, we can ship small quantity exception.
To do so, the package has to be shipped GROUND and the package has to be clearly labeled as described below.
...
![](img/FedExETHANOLSAMPLESsmallquantityexcpetion2.png)
