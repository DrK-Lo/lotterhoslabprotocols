...
[Edit this page](https://github.com/DrK-Lo/lotterhoslabprotocols/edit/main/molecprot_dnaextractionomega.qmd)
...
#### **Omega E.Z.N.A. Tissue DNA Kit - individual spin columns: good for extracting fewer than 8-16 samples or low yield samples. Cheaper per sample (\~\$1.4-\$3.2 per sample).** {.unnumbered}
...
#### **Omega E.Z. 96 Tissue DNA Kit - 96-well plate columns: good for extracting a large number of samples (saves time by using the multi-channel pipette and in number of centrifugation rounds). More expensive per sample (\~\$2.1-\$2.6 per sample).** {.unnumbered}

-   4 plates, 384 reactions - cat #: D1196-01

-   1 plate, 96 reactions - cat #: D1196-00

### **Reagents and Consumables** {.unnumbered}
...
### **Prepping for day 1 of extraction - check list:** {.unnumbered}
...
### **Prepping for day 2 of extraction - check list:** {.unnumbered}
...
### **Day 1 of extraction - tissue digestion** {.unnumbered}
...
### **Day 2 of extraction - DNA purification.** {.unnumbered}
...
[image](https://user-images.githubusercontent.com/98117631/183438550-75c4d11b-8d6a-4b37-8579-f74a95a913f5.png){alt="image"}
