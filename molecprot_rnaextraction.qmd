...
[Edit this page](https://github.com/DrK-Lo/lotterhoslabprotocols/edit/main/molecprot_rnaextraction.qmd)

The protocol for extracting RNA from tissue samples.

------------------------------------------------------------------------

-   [General tips for RNA extraction](https://drk-lo.github.io/lotterhoslabprotocols/molecprot_rnaextraction.html#general-tips-for-rna-extraction)

-   [Homogenize tissue sample with TissueRuptor](https://drk-lo.github.io/lotterhoslabprotocols/molecprot_rnaextraction.html#homogenize-tissue-sample-with-tissueruptor)

## **Kits that we use** {.unnumbered}

-   [TRI Reagent RNA Isolation](https://drk-lo.github.io/lotterhoslabprotocols/molecprot_rnaextraction.html#protocol-for-tri-reagent-rna-isolation)

    -   (Trizol based)

    -   Works well with *Crassostrea virginica*

-   [Qiagen RNAeasy Kit](https://drk-lo.github.io/lotterhoslabprotocols/molecprot_rnaextraction.html#protocol-with-qiagen-rnaeasy-kit)

-   [ZYMO Quick DNA/RNA Miniprep](https://drk-lo.github.io/lotterhoslabprotocols/molecprot_rnaextraction.html#protocol-for-zymo-quick-dna-rna-miniprep-and-tissueruptor-homogenization)

## **General tips for RNA extraction** {.unnumbered}
...
### **Homogenize tissue sample with TissueRuptor** {.unnumbered}
...
## **Protocol for TRI Reagent RNA Isolation** {.unnumbered}

Adapted from official protocol. Download [here](http://depts.washington.edu/kellylab/wordpress/wp-content/uploads/2020/10/Tri-Reagent-Protocol.pdf)
...
5.  Centrifuge at 12,000 x g for 10--15 min at 4°C, then transfer the aqueous phase to a fresh tube.
    ...
    -   The interphase and lower, red, organic phase can be stored at 4°C for subsequent isolation of DNA and protein. A protocol is posted [here](https://www.thermofisher.com/us/en/home/brands/invitrogen/ambion.html)
...
## **Protocol with Qiagen RNAeasy Kit** {.unnumbered}

### **Reagents and supplies** {.unnumbered}
...
### **Notes before starting** {.unnumbered}
...
## **Protocol for ZYMO Quick DNA RNA Miniprep and TissueRuptor homogenization** {.unnumbered}
