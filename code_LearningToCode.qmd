...
[Edit this page](https://github.com/DrK-Lo/lotterhoslabprotocols/edit/main/code_LearningToCode.qmd)
...
2.  You can use NU's [Open On Demand](ood.discovery.neu.edu) for R Studio, command line, and python, and more!
    ...
    -   To use OOD, you have to have an NU email, and have Discovery access (NU's HPC cluster).
        ...
        -   [Instructions to get Discovery access for non-NU people](https://github.com/DrK-Lo/lotterhoslabprotocols/blob/2205b0b11ab25138b001238eb535d09fed760fde/discovery_nonNEUpersonnel.qmd)
...
5. learning aspects of python based around Harry Potter examples (they changed names to avoid copyright problems). Note the GitHub page has link to blog posts that walk through the code. [https://github.com/zotroneneis/magical_universe](https://github.com/zotroneneis/magical_universe)
Here is the podcast about this, lots of other cool topics too. [https://talkpython.fm/episodes/show/186/100-days-of-python-in-a-magical-universe](https://talkpython.fm/episodes/show/186/100-days-of-python-in-a-magical-universe)
...
[http://benhaller.com/workshops/workshops.html](http://benhaller.com/workshops/workshops.html)
...
[https://github.com/thais-neu/Thais-learning-code](https://github.com/thais-neu/Thais-learning-code)
