...
[Edit this page](https://github.com/DrK-Lo/lotterhoslabprotocols/edit/main/field_collectsamprna.qmd)

The protocol for collecting samples for RNA extraction

------------------------------------------------------------------------

## **General tips** {.unnumbered}
...
## **Tips for flash freezing in liquid N2** {.unnumbered}
