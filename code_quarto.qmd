...
- [ ]  Make sure you follow [these directions](https://quarto.org/docs/publishing/github-pages.html#render-to-docs) to:
     - [ ]  output to docs
     - [ ]  add a .nojekyll file
     - [ ]  GitHub repository to publish from the docs directory
...
-  [ ] Next follow [these instructions](https://quarto.org/docs/publishing/github-pages.html#publish-action) to:
     - [ ] checking the Read and write permissions box under Workflow permissions
     - [ ] run `quarto publish gh-pages` locally, once 
     - [ ] sync to github
     - [ ] add a `publish.yml` GitHub Action
     - 
