...
- [ ] On your machine or on github
     ...
     - [ ] Add a `.nojekyll` file
     - [ ] if you created the last two files on your machine, sync to the web with GitHub Desktop
- [ ] Next follow [these instructions](https://quarto.org/docs/publishing/github-pages.html#publish-action) to:
     ...
     - [ ] On Github - checking the Read and Write Permissions box under Workflow permissions
     - [ ] On Github - add a `publish.yml` GitHub Action
