...
**Note** Some kits contain pre-made "working solution" other kits contain the working solution constituents and you must make a portion of the working solution yourself. Pay attention to the labels on the large brown bottles of the kit!

**Make sure you use the appropriate working solution for the assay you're running (BR or HS).** 

If you must make working solution, the kit will contain dsDNA "Buffer" and dsDNA "Reagent" (typically an orange-red colored fluid in a small tube). To make the standard, multiply the number of samples that you are running x 198 or 199 (depending on if you will do 2 uL or 1 uL of sample). Then see the sample math for a 2 uL sample (also in M.G.E's lab notebook, page 67). Prepare the total volume of working solution needed once. 
