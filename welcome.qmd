...
-   **Safety Data Sheets and Hazardous Waste**:
    ...
    -   All safety data sheets, chemical inventory and hazardous waste labels are in this binder... ![Alt text](https://drk-lo.github.io/lotterhoslabprotocols/img/labSafetyBinder.jpg){alt="Alt text"}
...
-   Our lab and some other labs at the MSC have access to a computing cluster (defiance) so we can run scripts and simulations that may take days to run. Refer to [this page](https://drk-lo.github.io/lotterhoslabprotocols/defiance/) in order to gain access and learn how to use defiance.
