...
- Magnetic stir plate (left of the -20 fridge)
...
1. Dilute 10X TAE Buffer to 1X. Pour 100mL 10X TAE in the large plastic graduated cyliner. Add 900mL MilliQ water until the mixture reaches the 1000mL mark. Pour and store in a 1L labelled glass bottle. The recipe for making more 10X TAE Buffer is below and [here](http://cshprotocols.cshlp.org/content/2006/1/pdb.rec8644.full) 
...
2. Mix the gel components.  
    ...
    d.	Use the magnetic stirring plate (put a stir bar inside the Erlenmeyer flask) to mix. Turn the RPM into the 500s until all the clumps are gone. Remove the stir bar with forceps. 
...
6. Pour the gel.
    ...
    <img width="457" alt="Screen Shot 2023-03-24 at 2 54 06 PM" src="https://user-images.githubusercontent.com/122108419/227614768-6b639160-04ff-4606-80b6-7f9fb6bc8161.png">
        ...
        i. If you are having issues with this method (leaks), you can set the gel in the rig if you flip the orientation of the tray so that it is confined.  Make sure to wet the red rubber gaskets so that it is easier to take out after it has set. The rig needs to be empty for this method (no buffer in it). 
...
11. Add ladder into the first well. 
    a.	Mix 1ul ladder, 1ul TriTrack loading dye, and 4ul DI H20. Mix on parafilm or in a Qubit tube. Fill ladder wells with 3ul (half) of this mixture. Repeat or make a double batch depending on how many ladders you have.
        ...
        ii. Aliquots of ladder can be found in the  -20 freezer. (we don't have an aliquot right now, you might have to mix ladder/TriTrack/DIH20 yourself. 
...
12. Load the gel.
    ...
    c.	Cut a piece of parafilm and tape to benchtop. You can label it with sample names or well numbers if that's helpful. 
...
:::	
    ...
    f.	Keep the same tip and pipette 3 ul of the dye/sample solution into the proper well of the gel.
...
::: {.callout-note}
# Use a 2- or 3-gel layout for a 96-well plate of samples
...
## 2 Gel Layout for a 96-well plate of samples

Gel 1:
![](img/2-gel-layout-protocol.png) 

Gel 2:
![](img/2-gel-layout-protocol.2.png) 
:::
...
:::{.callout-important}
## Gel waste 
- If the gel waste mayo jar is labelled with Lotterhos, ensure that the label is filled out correctly. GelRed and Bromophenol blue are not hazardous, and the label should be filled out as such if those are the only constituents. You should also ask others who use the gel mayo jar about what chemicals are in their gels. 
:::
