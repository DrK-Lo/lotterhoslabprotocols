...
5. Ensure SpeedVac is on the no heat setting and the timer is set for an adequate amount of time (at least 3 hours). Use plate attachment and place sample plate and counterweight into the holders. The lid will not open until the SpeedVac is on. 

6. Start SpeedVac. Check samples periodically for drying, remove plate as soon as everything is dry. If the process is slow, you can add more of the silicone grease. 
