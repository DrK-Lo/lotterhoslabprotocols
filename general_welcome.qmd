...
- [ ] Dr. Lotterhos will add you to the pop gen fika listserv
...
- [ ] If you will be using the Explorer/Discovery Cluster for computing, submit a request for an account. [Apply by opening a Service-Now ticket with an access request](https://rc-docs.northeastern.edu/en/latest/welcome/gettinghelp.html#submit-a-ticket)
