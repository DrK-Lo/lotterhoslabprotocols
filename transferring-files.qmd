...
## **How to ensure the files you are transferring are transferred successfully** {.unnumbered}
...
If not: `md5sum (list files) > md5sum.txt`

### **Step 2: Transfer files to new location (including the md5sum.txt)** {.unnumbered}
