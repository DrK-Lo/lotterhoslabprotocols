...
### **1. As soon as a new chemical/kit is delivered to our lab, assign it a barcoded label. You MUST use the barcoded labels provided by Northeastern's EHS. They start with "NU000" followed by a unique ID number.** {.unnumbered}
...
### **2. Add chemical/kit to the lab's chemical inventory.** {.unnumbered}

-   Go to the lab's BioRAFT page: Lotterhos Lab \> Lab Profile

-   Click on the ChemTracker tab \> Add inventory

-   Search chemical/kit by name, name or CAS number^[1](https://drk-lo.github.io/lotterhoslabprotocols/general_chemical_inventory/#fn:1)^
...
### **3. Remove items from the inventory when chemicals/kits are used up, expired or disposed of for any reason.** {.unnumbered}
...
1.  CAS registry numbers are unique, unmistakable identifiers for chemical substances. A CAS Registry Number itself has no inherent chemical significance but provides an unambiguous way to identify a chemical substance or molecular structure when there are many possible systematic, generic, proprietary or trivial names. CAS Registry Numbers are used in many other public and private databases as well as chemical inventory listings and, of course, are included in all CAS-produced databases. [↩](https://drk-lo.github.io/lotterhoslabprotocols/general_chemical_inventory/#fnref:1)\
    \
    \
    \
