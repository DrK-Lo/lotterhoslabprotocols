...
- Enter the info as prompted. If you are entering quant data from PicoGreen, make sure to select the right plate_standards_key. You can leave this entry blank if entering Qubit 
