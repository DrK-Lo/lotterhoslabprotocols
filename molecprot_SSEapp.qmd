...
![](img/7DF9D307-C481-4E69-8B0A-0008DDF1FF81.png){height=1%}
...
![](img/7DA7A498-2BA4-4888-B504-0C7E98CD41AA_1_201_a.jpeg){height=.01%}
...
- Click on the extraction date you want to enter quant data for. Scroll down to "DNA_quantifications" and click "Add" to enter data.
