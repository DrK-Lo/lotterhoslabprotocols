...
1\) [`cd` - Changing Directories](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands/#cd)\
2) [`find` - Finding files](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands/#find)\
3) [`ls` - Listing files](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands/#ls)\
4) [`sed` - Replacing texts in a file name](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands/#sed)\
5) [`chmod`- Changing file or folder permissions](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands/#chmod)\
6) [`wc` - Count words or lines or a file](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands/#wc)\
7) [`awk` - Printing specific lines or columns](https://drk-lo.github.io/lotterhoslabprotocols/code_unixcommands/#awk)
...
Use mac GUI: ![Change Permissions](https://drk-lo.github.io/img/changepermissions.gif){alt="Change Permissions"}
